#compares iasp91 used by axisem3d (as degree 5 curves) and Taup.
# axisem values from: https://gitlab.com/Salvus/SalvusMeshLite/-/tree/master/salvus_mesh_lite/data?ref_type=heads
import numpy as np
